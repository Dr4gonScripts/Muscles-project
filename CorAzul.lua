...
MainFrame.BackgroundColor3 = Color3.fromRGB(10, 10, 20) -- Cor de fundo azul escuro
...
UIStroke.Color = Color3.fromRGB(0, 100, 180) -- Borda azul
...
TitleBar.BackgroundColor3 = Color3.fromRGB(15, 15, 30) -- Barra de título mais escura
TitleBar.BorderSizePixel = 0
TitleBar.Parent = MainFrame

local Title = Instance.new("TextLabel")
Title.Text = "🐉 ROBLOKI HUB PREMIUM V5.0 🐉"
Title.TextColor3 = Color3.fromRGB(180, 220, 255) -- Texto em azul claro
...
MinimizeButton.BackgroundColor3 = Color3.fromRGB(0, 100, 180) -- Botão de minimizar azul
...
TabScrollingFrame.ScrollBarImageColor3 = Color3.fromRGB(0, 100, 180) -- Barra de rolagem azul
...
local function CreateTab(name)
    ...
    tab.BackgroundColor3 = Color3.fromRGB(30, 30, 50) -- Cor da aba
    ...
    tab.MouseEnter:Connect(function()
        game:GetService("TweenService"):Create(tab, TweenInfo.new(0.1), {
            BackgroundColor3 = Color3.fromRGB(50, 50, 80) -- Cor ao passar o mouse
        }):Play()
    end)
    
    tab.MouseLeave:Connect(function()
        game:GetService("TweenService"):Create(tab, TweenInfo.new(0.1), {
            BackgroundColor3 = Color3.fromRGB(30, 30, 50) -- Cor normal
        }):Play()
    end)
...
local function CreateContentFrame(name)
    ...
    frame.ScrollBarImageColor3 = Color3.fromRGB(0, 100, 180) -- Barra de rolagem azul
    frame.Visible = false
...
local function CreateButton(name, callback, parent)
    ...
    button.BackgroundColor3 = Color3.fromRGB(20, 20, 40) -- Cor do botão
    ...
    stroke.Color = Color3.fromRGB(0, 100, 180) -- Borda azul
    stroke.Thickness = 1
    stroke.Parent = button
    
    button.MouseEnter:Connect(function()
        game:GetService("TweenService"):Create(button, TweenInfo.new(0.1), {
            BackgroundColor3 = Color3.fromRGB(40, 40, 60), -- Cor ao passar o mouse
    ...
    button.MouseLeave:Connect(function()
        game:GetService("TweenService"):Create(button, TweenInfo.new(0.1), {
            BackgroundColor3 = Color3.fromRGB(20, 20, 40), -- Cor normal
...
local function CreateDivider(text, parent)
    ...
    label.Text = " "..text.." "
    label.TextColor3 = Color3.fromRGB(0, 100, 180) -- Cor do texto do divisor
    label.BackgroundColor3 = Color3.fromRGB(15, 15, 30) -- Fundo do texto
    ...
    leftLine.BackgroundColor3 = Color3.fromRGB(0, 100, 180)
    ...
    rightLine.BackgroundColor3 = Color3.fromRGB(0, 100, 180)
...
ProfileFrame.BackgroundColor3 = Color3.fromRGB(20, 20, 40) -- Fundo do perfil
...
PlayerThumbnail.BackgroundColor3 = Color3.fromRGB(30, 30, 50)
...
PlayerName.TextColor3 = Color3.fromRGB(180, 220, 255)
...
SearchBar.BackgroundColor3 = Color3.fromRGB(25, 25, 45) -- Fundo da barra de pesquisa
...
ResultsFrame.ScrollBarImageColor3 = Color3.fromRGB(0, 100, 180)
...
local function SearchScripts(query)
    ...
    if maxResults == 0 then
        ...
        for i = 1, maxResults do
            ...
            resultButton.BackgroundColor3 = Color3.fromRGB(30, 30, 50) -- Cor do botão de resultado
...
local function SwitchTab(selectedTab)
    ...
    for i, tab in ipairs(tabs) do
        if tab == selectedTab then
            tab.BackgroundColor3 = Color3.fromRGB(0, 100, 180) -- Cor da aba selecionada
            ...
            tab.BackgroundColor3 = Color3.fromRGB(30, 30, 50) -- Cor da aba não selecionada
