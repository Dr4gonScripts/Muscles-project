...
MainFrame.BackgroundColor3 = Color3.fromRGB(245, 245, 245) -- Cor de fundo branca
...
UIStroke.Color = Color3.fromRGB(150, 150, 150) -- Borda cinza claro
...
TitleBar.BackgroundColor3 = Color3.fromRGB(230, 230, 230) -- Barra de título mais clara
TitleBar.BorderSizePixel = 0
TitleBar.Parent = MainFrame

local Title = Instance.new("TextLabel")
Title.Text = "🐉 ROBLOKI HUB PREMIUM V5.0 🐉"
Title.TextColor3 = Color3.fromRGB(50, 50, 50) -- Texto em cinza escuro
...
MinimizeButton.BackgroundColor3 = Color3.fromRGB(200, 200, 200) -- Botão de minimizar cinza claro
...
TabScrollingFrame.ScrollBarImageColor3 = Color3.fromRGB(150, 150, 150) -- Barra de rolagem cinza claro
...
local function CreateTab(name)
    ...
    tab.BackgroundColor3 = Color3.fromRGB(220, 220, 220) -- Cor da aba cinza claro
    ...
    tab.MouseEnter:Connect(function()
        game:GetService("TweenService"):Create(tab, TweenInfo.new(0.1), {
            BackgroundColor3 = Color3.fromRGB(200, 200, 200) -- Cor ao passar o mouse
        }):Play()
    end)
    
    tab.MouseLeave:Connect(function()
        game:GetService("TweenService"):Create(tab, TweenInfo.new(0.1), {
            BackgroundColor3 = Color3.fromRGB(220, 220, 220) -- Cor normal
        }):Play()
    end)
...
local function CreateContentFrame(name)
    ...
    frame.ScrollBarImageColor3 = Color3.fromRGB(150, 150, 150) -- Barra de rolagem cinza claro
    frame.Visible = false
...
local function CreateButton(name, callback, parent)
    ...
    button.BackgroundColor3 = Color3.fromRGB(230, 230, 230) -- Cor do botão cinza claro
    ...
    stroke.Color = Color3.fromRGB(150, 150, 150) -- Borda cinza claro
    stroke.Thickness = 1
    ...
    button.MouseLeave:Connect(function()
        game:GetService("TweenService"):Create(button, TweenInfo.new(0.1), {
            BackgroundColor3 = Color3.fromRGB(230, 230, 230), -- Cor normal
            TextColor3 = Color3.fromRGB(50, 50, 50)
        }):Play()
    end)
...
local function CreateDivider(text, parent)
    ...
    label.Text = " "..text.." "
    label.TextColor3 = Color3.fromRGB(100, 100, 100) -- Cor do texto do divisor cinza
    label.BackgroundColor3 = Color3.fromRGB(230, 230, 230) -- Fundo do texto cinza claro
    ...
    leftLine.BackgroundColor3 = Color3.fromRGB(150, 150, 150)
    ...
    rightLine.BackgroundColor3 = Color3.fromRGB(150, 150, 150)
...
ProfileFrame.BackgroundColor3 = Color3.fromRGB(230, 230, 230) -- Fundo do perfil cinza claro
...
PlayerThumbnail.BackgroundColor3 = Color3.fromRGB(210, 210, 210)
...
GameName.TextColor3 = Color3.fromRGB(100, 100, 100)
...
SearchBar.BackgroundColor3 = Color3.fromRGB(240, 240, 240) -- Fundo da barra de pesquisa cinza claro
SearchBar.TextColor3 = Color3.fromRGB(50, 50, 50)
...
local function SearchScripts(query)
    ...
    if maxResults == 0 then
        ...
        noResults.TextColor3 = Color3.fromRGB(50, 50, 50)
        ...
        for i = 1, maxResults do
            ...
            resultButton.BackgroundColor3 = Color3.fromRGB(220, 220, 220) -- Cor do botão de resultado cinza claro
            resultButton.TextColor3 = Color3.fromRGB(50, 50, 50)
            ...
            categoryLabel.TextColor3 = Color3.fromRGB(0, 150, 255) -- Cor da categoria
...
local function SwitchTab(selectedTab)
    ...
    for i, tab in ipairs(tabs) do
        if tab == selectedTab then
            tab.BackgroundColor3 = Color3.fromRGB(200, 200, 200) -- Cor da aba selecionada (cinza mais escuro)
            contents[i].Visible = true
            game:GetService("TweenService"):Create(tab, TweenInfo.new(0.2), {
                BackgroundColor3 = Color3.fromRGB(200, 200, 200)
            }):Play()
        else
            tab.BackgroundColor3 = Color3.fromRGB(220, 220, 220) -- Cor da aba não selecionada
